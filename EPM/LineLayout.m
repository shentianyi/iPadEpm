...
#define SECTION_INSETS_PORTRAIT UIEdgeInsetsMake(100.0f, 0.0f, 100.0f, 0.0f)
#define SECTION_INSETS_LANDSCAPE UIEdgeInsetsMake(100.0f, 0.0f, 100.0f, 0.0f);
...
- (id)init
{
    ...
    if (self) {
        ...
        self.itemSize = CGSizeMake(250.0f,150.0f);
